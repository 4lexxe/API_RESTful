...
//-------------------------
// Schema para actualizar publicación (todos los campos requeridos para PUT)
//-------------------------
...
const validateUpdatePublicacion = (data) => {
  return updatePublicacionSchema.validate(data);
};

module.exports = {
  validatePublicacion,
  validateUpdatePublicacion
};
